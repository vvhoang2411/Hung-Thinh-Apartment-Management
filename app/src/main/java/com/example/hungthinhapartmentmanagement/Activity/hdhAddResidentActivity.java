...
public class hdhAddResidentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(hdhAddResidentActivity.this, hdhResidentManagement.class);
        ...
        View.OnClickListener dateClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(hdhAddResidentActivity.this,
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        if (!task.getResult().isEmpty()) {
                            // Email đã tồn tại
                            Toast.makeText(hdhAddResidentActivity.this, "Email đã được sử dụng, vui lòng chọn email khác!", Toast.LENGTH_SHORT).show();
                            return;
                        }
                                        ...
                                        if (user != null) {
                                            ...
                                            db.collection("users").document(uid)
                                                    ...
                                                    .addOnSuccessListener(aVoid -> {
                                                        ...
                                                        Residents residents = new Residents(apartmentNumber, birth, email, name,
                                                                gender, phone, relationship, uid);
                                                        db.collection("residents").document(uid)
                                                                .set(residents)
                                                                .addOnSuccessListener(aVoid1 -> {
                                                                    Toast.makeText(hdhAddResidentActivity.this, "Thêm cư dân thành công", Toast.LENGTH_SHORT).show();
                                                                    Intent intent = new Intent(hdhAddResidentActivity.this, hdhResidentManagement.class);
                                                                    startActivity(intent);
                                                                    finish();
                                                                })
                                                                .addOnFailureListener(e -> Toast.makeText(hdhAddResidentActivity.this, "Lỗi khi thêm cư dân: " + e.getMessage(), Toast.LENGTH_SHORT).show());
                                                    })
                                                    .addOnFailureListener(e -> Toast.makeText(hdhAddResidentActivity.this, "Lỗi khi thêm user: " + e.getMessage(), Toast.LENGTH_SHORT).show());
                                        }
                                    } else {
                                        Toast.makeText(hdhAddResidentActivity.this, "Đăng ký thất bại: " + task1.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                });
                    } else {
                        Toast.makeText(hdhAddResidentActivity.this, "Lỗi khi kiểm tra email: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
