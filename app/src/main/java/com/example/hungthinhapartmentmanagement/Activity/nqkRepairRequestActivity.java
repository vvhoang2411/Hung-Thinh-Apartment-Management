...
public class nqkRepairRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(v -> {
            Intent intent = new Intent(nqkRepairRequestActivity.this, nqkRepairRequestListActivity.class);
        ...
        btnSend.setOnClickListener(v -> {
            ...
            if (title.isEmpty() || description.isEmpty()) {
                Toast.makeText(nqkRepairRequestActivity.this, "Vui lòng điền đầy đủ thông tin", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            repairRequestHelper.createRepairRequest(request, new RepairRequestHelper.OnOperationListener() {
                ...
                public void onSuccess() {
                    Toast.makeText(nqkRepairRequestActivity.this, "Gửi yêu cầu thành công", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(nqkRepairRequestActivity.this, nqkRepairRequestListActivity.class);
                    intent.putExtra("apartmentId", apartmentId);
                    intent.putExtra("fullName", fullName);
                    intent.putExtra("phone", phone);
                ...
                public void onError(String errorMessage) {
                    Toast.makeText(nqkRepairRequestActivity.this, "Lỗi khi gửi yêu cầu: " + errorMessage, Toast.LENGTH_SHORT).show();
                }
            });
        });
    }
