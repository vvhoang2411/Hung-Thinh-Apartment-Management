...
public class ManagementDetailRequestActivity extends AppCompatActivity {
        ...
        btnCapNhat.setOnClickListener(v -> {
            ...
            repairRequestHelper.updateRequestStatus(documentId, newStatus, new RepairRequestHelper.OnOperationListener() {
                ...
                public void onSuccess() {
                    Toast.makeText(ManagementDetailRequestActivity.this, "Cập nhật trạng thái thành công", Toast.LENGTH_SHORT).show();
                    // Chuyển về ManagementRepairRequestActivity
                    Intent returnIntent = new Intent(ManagementDetailRequestActivity.this, ManagementRepairRequestActivity.class);
                ...
                public void onError(String errorMessage) {
                    ...
                    Toast.makeText(ManagementDetailRequestActivity.this, "Lỗi: " + errorMessage, Toast.LENGTH_SHORT).show();
                }
            });
        });
