...
public class hdhAddApartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(hdhAddApartActivity.this, hdhApartmentManagement.class);
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        if (querySnapshot != null && !querySnapshot.isEmpty()) {
                            ...
                            Toast.makeText(hdhAddApartActivity.this, "Số căn hộ đã tồn tại!", Toast.LENGTH_SHORT).show();
                        } else {
                            // Nếu không trùng, thêm vào Firestore
                            addApartmentToFirestore(floor, number, area, desc, status);
                        }
                    } else {
                        Toast.makeText(hdhAddApartActivity.this, "Lỗi khi kiểm tra: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void addApartmentToFirestore(String floor, String number, String area, String desc, String status) {
        ...
        db.collection("apartments")
                ...
                .addOnSuccessListener(documentReference -> {
                    Toast.makeText(hdhAddApartActivity.this, "Thêm căn hộ thành công!", Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(e -> {
                    Toast.makeText(hdhAddApartActivity.this, "Thêm căn hộ thất bại: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
