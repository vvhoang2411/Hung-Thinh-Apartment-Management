...
public class hdhEditApartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(hdhEditApartActivity.this, hdhApartmentManagement.class);
        ...
        db.collection("apartments")
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        if (querySnapshot != null && !querySnapshot.isEmpty()) {
                            ...
                            for (com.google.firebase.firestore.QueryDocumentSnapshot document : querySnapshot) {
                                if (!document.getId().equals(currentId)) {
                                    Toast.makeText(hdhEditApartActivity.this, "Số căn hộ đã tồn tại!", Toast.LENGTH_SHORT).show();
                                    return;
                                }
                            }
                        }
                        ...
                        Toast.makeText(hdhEditApartActivity.this, "Lỗi khi kiểm tra: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void updateApartmentInFirestore(String id, String floor, String number, String area, String desc, String status) {
        ...
        db.collection("apartments")
                ...
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(hdhEditApartActivity.this, "Cập nhật thành công!", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(hdhEditApartActivity.this, hdhApartmentManagement.class);
                    startActivity(intent);
                    finish(); // Đóng activity sau khi cập nhật
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(hdhEditApartActivity.this, "Cập nhật thất bại: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
