...
public class RepairRequestListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new RepairRequestListAdapter(this, repairRequestList);
        ...
        helper.getActiveRequestsByApartmentId(apartmentId, new RepairRequestHelper.OnDataRetrievedListener() {
            ...
            public void onDataRetrieved(List<RepairRequest> repairRequests) {
                ...
                if (repairRequests.isEmpty()) {
                    Toast.makeText(RepairRequestListActivity.this, "Không có yêu cầu sửa chữa nào.", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onError(String errorMessage) {
                Toast.makeText(RepairRequestListActivity.this, "Lỗi khi tải dữ liệu: " + errorMessage, Toast.LENGTH_SHORT).show();
            }
        });
    }
}