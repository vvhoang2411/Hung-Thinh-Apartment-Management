...
import com.example.hungthinhapartmentmanagement.Adapter.ResidentInvoiceAdapter;
...
public class ResidentInvoiceActivity extends AppCompatActivity {
    private String apartmentId;
    private Spinner spinnerLoaiHoaDon, spinnerTrangThai;
    private Button btnTimKiem;
    private ImageButton btnBack;
    private RecyclerView recyclerView;
    private ResidentInvoiceAdapter invoiceAdapter;
    private InvoiceHelper invoiceHelper;
    private String selectedFeeType = "all";
    private String selectedStatus = "all";
    private static final String TAG = "ResidentInvoiceActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        invoiceAdapter = new ResidentInvoiceAdapter(this, new ArrayList<>());
