...
import com.example.hungthinhapartmentmanagement.Adapter.hdhApartmentAdapter;
...
public class hdhApartmentManagement extends AppCompatActivity {
    private FirebaseFirestore db;
    private RecyclerView recyclerView;
    private hdhApartmentAdapter adapter;
    private List<Apartments> apartmentList; // Danh sách gốc
    private List<Apartments> filteredList; // Danh sách đã lọc
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTransAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(hdhApartmentManagement.this, hdhAddApartActivity.class);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(hdhApartmentManagement.this, hdhMainActivity.class);
        ...
        adapter = new hdhApartmentAdapter(this, filteredList);
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        for (QueryDocumentSnapshot document : task.getResult()) {
                            ...
                            Apartments apartment = new Apartments(id, apartmentNumber, area, desc, floor, status);
