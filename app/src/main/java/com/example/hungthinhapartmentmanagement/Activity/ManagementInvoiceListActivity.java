...
import com.example.hungthinhapartmentmanagement.Adapter.ManagementInvoiceAdapter;
...
public class ManagementInvoiceListActivity extends AppCompatActivity {
    private String apartmentId;
    private Spinner spinnerLoaiHoaDon, spinnerTrangThai;
    private Button btnTimKiem;
    private ImageButton btnBack, btnAdd;
    private RecyclerView recyclerView;
    private ManagementInvoiceAdapter invoiceAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        invoiceAdapter = new ManagementInvoiceAdapter(this, new ArrayList<>());
        ...
        btnBack.setOnClickListener(v -> {
            Intent intent = new Intent(ManagementInvoiceListActivity.this, ManagementFindApartmentActivity.class);
            startActivity(intent);
        });

        // Setup add button listener
        btnAdd.setOnClickListener(v -> {
            Intent intent = new Intent(ManagementInvoiceListActivity.this, ManagementInvoiceCreateActivity.class);
