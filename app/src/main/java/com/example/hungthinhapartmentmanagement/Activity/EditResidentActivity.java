    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener dateClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditResidentActivity.this,
                ...
                .addOnSuccessListener(documentSnapshot -> {
                    if (documentSnapshot.exists()) {
                        ...
                        if (spinnerPosition >= 0) {
                            ...
                            Toast.makeText(EditResidentActivity.this, "Phòng hiện tại không còn trong danh sách 'Đã có'", Toast.LENGTH_SHORT).show();
                ...
                .addOnSuccessListener(aVoid -> {
                    ...
                    db.collection("users").document(residentId)
                            ...
                            .addOnSuccessListener(aVoid1 -> {
                                Toast.makeText(EditResidentActivity.this, "Cập nhật cư dân thành công", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(EditResidentActivity.this, ResidentManagement.class);
                                startActivity(intent);
                                finish();
                            })
                            .addOnFailureListener(e -> Toast.makeText(EditResidentActivity.this, "Lỗi khi cập nhật users: " + e.getMessage(), Toast.LENGTH_SHORT).show());
                })
