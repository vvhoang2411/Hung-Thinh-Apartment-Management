...
import com.example.hungthinhapartmentmanagement.Activity.nqkNotificationDetailActivity;
...
public class nqkAnnouncementAdapter extends RecyclerView.Adapter<nqkAnnouncementAdapter.ViewHolder> {
    ...
    public nqkAnnouncementAdapter(Context context, List<Announcement> announcements, String currentEmail, String apartmentId) {
        ...
        holder.cardView.setOnClickListener(v -> {
            ...
            executorService.execute(() -> {
                try {
                    ...
                    uiHandler.post(() -> {
                        Intent intent = new Intent(context, nqkNotificationDetailActivity.class);
