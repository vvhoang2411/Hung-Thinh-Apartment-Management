...
public class RepairRequestListAdapter extends RecyclerView.Adapter<RepairRequestListAdapter.ViewHolder> {

    private final List<RepairRequest> repairRequestList;
    private final Context context;
    private final RepairRequestHelper repairRequestHelper;

    public RepairRequestListAdapter(Context context, List<RepairRequest> repairRequestList) {
