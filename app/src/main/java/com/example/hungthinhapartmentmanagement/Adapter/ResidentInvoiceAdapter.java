...
import com.example.hungthinhapartmentmanagement.Activity.ResidentPaymentActivity;
...
public class ResidentInvoiceAdapter extends RecyclerView.Adapter<ResidentInvoiceAdapter.InvoiceViewHolder> {
    private List<Invoice> invoiceList;
    private Context context;

    public ResidentInvoiceAdapter(Context context, List<Invoice> invoiceList) {
    ...
    public void onBindViewHolder(@NonNull InvoiceViewHolder holder, int position) {
        ...
        if (!invoice.isStatus()) {
            holder.itemView.setOnClickListener(v -> {
                Intent intent = new Intent(context, ResidentPaymentActivity.class);
