...
import com.example.hungthinhapartmentmanagement.Activity.nmtManagementDetailRequestActivity;
...
public class nmtManagementRepairRequestAdapter extends RecyclerView.Adapter<nmtManagementRepairRequestAdapter.ViewHolder> {

    private final List<RepairRequest> repairRequestList;
    private final Context context;
    private static final String TAG = "ManagementRepairRequestAdapter";

    public nmtManagementRepairRequestAdapter(Context context, List<RepairRequest> repairRequestList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.btnDetail.setOnClickListener(v -> {
            Intent intent = new Intent(context, nmtManagementDetailRequestActivity.class);
