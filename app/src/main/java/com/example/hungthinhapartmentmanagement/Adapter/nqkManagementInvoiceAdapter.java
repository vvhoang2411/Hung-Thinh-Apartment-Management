...
import com.example.hungthinhapartmentmanagement.Activity.nqkManagementInvoiceUpdateActivity;
...
public class nqkManagementInvoiceAdapter extends RecyclerView.Adapter<nqkManagementInvoiceAdapter.InvoiceViewHolder> {
    private List<Invoice> invoiceList;
    private Context context;

    public nqkManagementInvoiceAdapter(Context context, List<Invoice> invoiceList) {
    ...
    public void onBindViewHolder(@NonNull InvoiceViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            Intent intent = new Intent(context, nqkManagementInvoiceUpdateActivity.class);
