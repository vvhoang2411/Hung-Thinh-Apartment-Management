...
import com.example.hungthinhapartmentmanagement.Activity.nmtManagementEditDeviceActivity;
...
public class nmtManagementControlDeviceAdapter extends RecyclerView.Adapter<nmtManagementControlDeviceAdapter.DeviceViewHolder> {

    private final Context context;
    private final List<Device> deviceList;
    private final List<String> documentIds;

    public nmtManagementControlDeviceAdapter(Context context, List<Device> deviceList, List<String> documentIds) {
    ...
    public void onBindViewHolder(@NonNull DeviceViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            Intent intent = new Intent(context, nmtManagementEditDeviceActivity.class);
