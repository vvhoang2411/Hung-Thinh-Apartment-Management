...
import com.example.hungthinhapartmentmanagement.Activity.ManagementNotificationDetailActivity;

import java.text.SimpleDateFormat;
import java.util.List;
import java.util.Locale;

public class ManagementNotificationAdapter extends RecyclerView.Adapter<ManagementNotificationAdapter.ViewHolder> {

    private List<Announcement> announcementList;
    private final SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy HH:mm", Locale.getDefault());
    private final Context context;

    public ManagementNotificationAdapter(Context context, List<Announcement> announcementList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.mt_item_notify, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            Intent intent = new Intent(context, ManagementNotificationDetailActivity.class);
