...
import com.example.hungthinhapartmentmanagement.Activity.nqkManagementInvoiceListActivity;
import java.util.ArrayList;
import java.util.List;

public class nqkFindApartmentAdapter extends RecyclerView.Adapter<nqkFindApartmentAdapter.ResidentViewHolder> {
    private List<Resident> residentList;
    private Context context;

    public nqkFindApartmentAdapter(Context context, List<Resident> residentList) {
    ...
    public void onBindViewHolder(@NonNull ResidentViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            ...
            if (apartmentId != null) {
                Intent intent = new Intent(context, nqkManagementInvoiceListActivity.class);
